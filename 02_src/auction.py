...
def init_auction_method(parking_capacities, vehicle_ids, starting_prices, parking_mtx, betas=None, bid_step = 5, max_price = 1000)-> (list, list):
    ...
    for i, b_i in enumerate(vehicle_ids):
        buyers.append(Buyer(b_i, parking_mtx[b_i], beta = betas_[b_i], pvmax=max_price))
